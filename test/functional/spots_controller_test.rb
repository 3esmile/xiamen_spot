...
class SpotsControllerTest < ActionController::TestCase
  ...
  test "should create spot" do
    assert_difference('Spot.count') do
      post :create, spot: { address: @spot.address, image: @spot.image, name: @spot.name, pinyin: @spot.pinyin, url: @spot.url }
    end
  ...
  test "should update spot" do
    put :update, id: @spot, spot: { address: @spot.address, image: @spot.image, name: @spot.name, pinyin: @spot.pinyin, url: @spot.url }
    assert_redirected_to spot_path(assigns(:spot))
  end
